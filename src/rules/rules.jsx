    ...
    return (
        <div className='main-page'>
            ...
            <main>
                ...
                <p>On the <NavLink to='start'>main page,</NavLink> hit "Open Lobby" at the bottom to create a new room. Let your fellow ambassadors know the 4-letter code to they can enter too. When you're ready to begin, hit the "Start" button!</p>
